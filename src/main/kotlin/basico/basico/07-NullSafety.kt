...
fun main() {
    ...
    println(nombre)
    nombre = "Pepe" // Prueba a comentar esto a ver que pasa!
    println(nombre)
    ...
    // Llamadas seguras, podemos llamar a un método de un objeto qie podría hacer uso de nulo
    ...
    // Imagina que tenemos una clase de Java, pero en java cualqueir objeto puede ser nulo y no nulo
